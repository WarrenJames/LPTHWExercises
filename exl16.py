...
# target variable with a decimal operator with the truncate command with no
# parameters deletes all of variable's contents
target.truncate()
...
# target variable with a decimal operator with the write command with line1
# variable in parameters
target.write(line1)
# writes new line in target variable
target.write("\n")
# writes line2 string in target variable
target.write(line2)
# writes new line in target variable
target.write("\n")
# writes line3 string in target variable
target.write(line3)
# writes new line in target variable
target.write("\n")
